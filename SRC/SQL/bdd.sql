...
create table formule(
        idf int(10) Auto_increment NOT NULL,
        nom Varchar(100),
        prix Float,
        primary key(idf)
);
...
CREATE TABLE client(
        ...
        idgrp           Int NOT NULL,
        PRIMARY KEY (idu),
        FOREIGN key (idf) REFERENCES formule(idf),
	FOREIGN KEY (idu_moniteur) REFERENCES moniteur(idu),
	FOREIGN KEY (idgrp) REFERENCES grp(idgrp)
)ENGINE=InnoDB;


create table facture(
        idfa int(10) Auto_increment NOT NULL,
        idu  Int NULL,
        nom varchar(50),
        link varchar(255),
        primary key(idfa),
...
INSERT INTO `formule` (`idf`, `nom`, `prix`) VALUES (NULL, 'Code', '30'),(NULL, 'Code et permis', '750'), (NULL, 'Permis', '700');
