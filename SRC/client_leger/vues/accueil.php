...
<center>
 <h1 class="my-4">Bienvenue sur,
      ...
      <p>Ce site à pour bute de vous former dans les meilleures conditions possibles.
      <br>  Nous serons ravis de vous recevoir au sein de notre établissement !</p>
      <br>
</center>
<section>
  <div class="row">
    <div class="col-sm">
      <div class="col">
        ...
        <center><b>Réservez vos cours de conduite en ligne , <br>facilement grâce à notre site ergonomique.</b></center>
      </div>
      <br>
      <br>
    </div>
    <div class="col-sm">
      ...
      <center><b>Vous pouvez voir votre <br>votre progression directement sur notre site.</b>
    </div>
    <br>
    </div>
</section>
