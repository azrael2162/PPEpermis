        ...
        if ($prenom && $nom && $email && $date && $tel && $adress && $zip) {
           ...
           if (strlen($passwd) > 6) {
            ...
            $psswcrypt = sha1($passwd);
              ...
              $requete = "INSERT INTO client (`idu`,`idf`,`idfa`, `adresse`, `code_zip`,`datenaissa`, `tel`, `nom`, `prenom`, `mail`, `passwd`, `valider`, `idu_moniteur`, `idgrp`) VALUES
              (NULL,NULL,NULL, '$adress', '$zip', '$date', '$tel', '$nom', '$prenom', '$email', '$psswcrypt','0', NULL, '2');";
